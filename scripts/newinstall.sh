...
LSST_SPLENV_REF=${LSST_SPLENV_REF:-${LSST_LSSTSW_REF:-0.7.0}}
...
NEWINSTALL_URL="https://raw.githubusercontent.com/lsst/lsst/23.0.x/scripts/newinstall.sh"
...
n8l::print_greeting() {
	cat <<-EOF
		...
		An official release tag such as "v23_0_0" can also be used.
